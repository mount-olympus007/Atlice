...
namespace Atlice.WebUI.Pages.Admin
{
    ...
    public class UsersModel : PageModel
    {
        ...
        public UsersModel(IDataRepository repo, IServices _services, UserManager<ApplicationUser> manager, SignInManager<ApplicationUser> _signInManager)
        {
            userManager = manager;
        ...
        public async Task<IActionResult> OnGetSendCredText(Guid userid)
        {
            ...
            {
                await services.SendTextAsync(user.PhoneNumber, "Alexander Oliver has invited you to the Atlice Tap V3 beta. Use this link to verify your credentials. https://atlice.com/betaask/credential_prospect" + " \n Add Atlice Tap to your contacts with this link: https://atlice.com/cards?email=atlicetap@atlice.com&contactid=0");
