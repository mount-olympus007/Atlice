...
{
    [Authorize(Roles ="Adminis,Citizen,Tourist")]
    public abstract class WebSocketHandler
    {
        ...
        public virtual async Task OnConnected(WebSocket socket, string username)
        {
            ...
            {
                ServerMessage connectStatus = new ServerMessage(username, false, new List<string> { username });
                await BroadcastMessage(JsonSerializer.Serialize(connectStatus));
        ...
        public string ValidateUsername(string username)
        {
            ...
            if(username == "Admin")
                if(ConnectionManager.UsernameAlreadyExists("allen.c.bradford@gmail.com") || ConnectionManager.UsernameAlreadyExists("lexdamas@gmail.com"))
